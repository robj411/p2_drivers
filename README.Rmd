...
$$p_{14}=\frac{1}{365}\int_{t=1}^{T}(1-x_{ed}(t))dt,$$
and $A$ represents education lost due to student sickness with COVID-19:

$$A=\int_{t=0}^T\left(p_3I_{g_{\text{school}}}^{(A)} + p_4I_{g_{\text{school}}}^{(S)}+H_{g_{\text{school}}}\right)dt.$$ 
$p_3$ is the fraction of asymptomatic infectious averted by self isolating, and $p_4$ is the fraction of symptomatic infectious averted by self isolating.
