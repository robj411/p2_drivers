...
With $M(\textbf{1})$, $M^{\text{CW}}(\textbf{1})$, $M^{\text{WW}}(\textbf{1})$ and $M^{\text{WC}}(\textbf{1})$, we learn $M^{\text{com}}(\textbf{1})$. 
...
Finally, $M^{\text{CC}}(\textbf{1})$ is sampled as a fraction of $M^{\text{com}}(\textbf{1})- M^{\text{sch}}(\textbf{1}) - M^{\text{tran}}(\textbf{1})$, which leaves $M^{\text{home}}$.


### Matrix $M^{\text{com}}$: community contacts

We construct $M^{\text{com}}(x)$ from its constituent parts, representing intra- and inter-household interactions (home), school interactions (sch), hospitality interactions (CC) and travel interactions (tran):
