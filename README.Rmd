...
$w_{u,v,i}(t)$ is the rate of vaccination from level $u$ to level $v$. $w_{2,v,i}(t)=0$. $m_{v,i}$ is the rate of maturation of immunity following vaccination. $m_{0,i}=0$ and $M_{0,i}\equiv 0$.
