...
```{r school1frac,fig.cap='Fraction of contacts made at school for ages 0 to 4.', echo=F,message=F,warning=F,fig.width=3}
knitr::include_graphics(path = "README_files/figure-gfm/school1frac.png")
```

```{r school2frac,fig.cap='Fraction of contacts made at school for ages 0 to 4.', echo=F,message=F,warning=F,fig.width=3}
knitr::include_graphics(path = "README_files/figure-gfm/school2frac.png")
```

```{r hospfrac,fig.cap='Fraction of non-school and non-work contacts made in hospitality settings, by age group.', echo=F,message=F,warning=F,fig.width=1}
