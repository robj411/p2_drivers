...
```{tikz statetransitions, fig.cap = "Disease state transitions. $S$: susceptible. $E$: exposed. $I^{(A)}$: asymptomatic infectious. $I^{(S)}$: symptomatic infectious. $H$: hospitalised. $R$: recovered. $D$: died. $i$: stratum. $v$: vaccination status.", fig.ext = 'png',echo=F}
