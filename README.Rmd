...
\node[latent] (S) {$S_{j,v=0}$} ; %
    ...
    \draw [arrow] (S) edge[bend right] node [left] {$k_{10,c_2}^{j,v=0}(t)$} (S02);
    \draw [arrow] (R) edge[bend left] node [right] {$k_{10,c_2}^{j,v=0}(t)$} (Rv2);
