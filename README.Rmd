...
The VLY reflects individuals' willingness to trade wealth for reductions in risk of mortality. We rely on the intrinsic rather than instrumental interpretation of the valuation of life [@Cutler2020], and we use an existing estimate of the value of a statistical life (VSL) to estimate VLY. We interpret the VSL as a population-weighted average [@Ananthapavan2021; @Robinson2021], where each age group has a VSL defined by the number of expected life years remaining, and where each year has the same value: 
