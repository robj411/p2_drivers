...
We assign monetary values to dYLLs and to years of education in order to add health and education costs of sector-closure policies to the costs of economic closures. We define the total socio-economic costs TSC of an epidemic as the sum of the individual costs:
...
where $K_1$ is the number of discounted life years lost and VdLY the value of a discounted life year; $K_2$ is the lost GDP over the period due to reduced economic activity; and $K_3$ is the number of school years lost and VSY the value of one school year.
