...
- At the response time, the BPSV, if present, is given to people aged 65 and older; testing begins; economic closures, if in use, are implemented
...
- When vaccine rollout is complete, closures and testing end
