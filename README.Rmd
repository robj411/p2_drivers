...
## Parametric distributions informed by data
...
lg <- 'Parameter distributions. Tourism parameters are those described in Section \\@ref(dependence-on-international-tourism). \\label{tab:paramdist}'
if (!knitr::is_html_output(excludes = "markdown")) { 
