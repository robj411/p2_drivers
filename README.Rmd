...
Here, $\text{VSL}_{\text{USA}}$ is the VSL of the USA (10.9 million \$) and $\text{GDP}_{\text{USA}}$. We sample two random variables to encode a choice of method from @Robinson2021: $r_p$ is a conversion from GDP to GDP with PPP, which is 1 with probability 0.5 and an income-level--specific random variable with probability 0.5. $r_e$ is an elasticity relating VSL to GDP, which is 1 with probability 0.5 and an income-level--specific random variable with probability 0.5. 
...
Table: values for elasticities, from @Robinson2021, Table 2 (page 25)
