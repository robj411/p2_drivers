...
$$A_{1,j}(t)=\sum_{v=0}^2\left((1-p_{H,j,v})p_4p_{18}^{(S)}I_{j,v}^{s}+p_{H,j,v}p_4I_{j,v}^{s}+H_{j,v}+D_{j,v}\right),$$

and $A_{2,j}(t)$ represents output from asymptomatic self-isolating
workers:

$$A_{2,j}(t)=p_3p_{18}^{(A)}I_{j}^{a}.$$
...
$I_{j,v}^{a}$, infectious and symptomatic $I_{j,v}^{s}$, hospitalised
$H$, deceased $D$, and probability to be hospitalised $p_H$.
...
$$B_1(t)=\sum_{v=0}^2\left((1-p_{H,j_{\text{school}},v})p_4p_{18}^{(S)}I_{j_{\text{school}},v}^{s}+p_{H,j_{\text{school}},v}p_4I_{j_{\text{school}},v}^{s}+H_{j_{\text{school}},v}\right),$$
...
$$B_2(t)=p_3p_{18}^{(A)}I_{j_{\text{school}}}^{a}.$$
