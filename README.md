...
``` math
\hat{x}_{i}(t)=x_{i}(t) - \left((1-x_{i}(t))B_{1,i}(t)  + (1-x_{i}(t)(1-p_{19,i}))B_{2,i}(t)\right)/w_i
```
...
``` math
M_{gg'}^{(4)} = \frac{\sum_{a\in g}\hat{P}_{a}\sum_{a'\in g'}M^{(16)}_{a,a'}}{\sum_{a\in g}\hat{P}_{a}},
```
...
With $M(\textbf{1})$, $C(\textbf{1})$, $B(\textbf{1})$ and
