...
colnames(tabres) <- c('Country','Vaccination','Income group','Total value','YLLs','Education','GDP')
...
```{r iseq,fig.cap='Closures for HICs under the Economic Closures strategy.',echo=F,warning=F,message=F,fig.height=5,fig.width=7}
## iseq ########################
