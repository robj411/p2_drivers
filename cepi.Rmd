...
colnames(difflist)[colnames(difflist)=='dYLLs'] <- 'YLL'
...
# tabres[,Scenario:=paste0(Vaccine,' days, ',c('no BPSV','BPSV')[BPSV]),by=.(BPSV,Vaccine)]

lg <- 'Value of vaccines as a percent of GDP: differences between BAU and scenarios. Mean values and 95% prediction intervals. \\label{tab:tabresdiff}'
if (!knitr::is_html_output(excludes = "markdown")) { 
