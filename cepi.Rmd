...
setDT(meltmeantab)
meltmeantab[,cost:=sum(value),by=.(igroup,scencountry,strategy)]
meltmeantab[,mincost:=cost==min(cost),by=.(igroup,scencountry)]
ggplot(meltmeantab) + 
  ...
  facet_grid(scencountry~factor(igroup,levels=c('LLMIC','UMIC','HIC'))) + 
