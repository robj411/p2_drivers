...
Selecting the mitigation strategy that minimised the expected cost for each country type and income level and vaccination scenario, we estimate the value of the vaccines as the difference in costs.
