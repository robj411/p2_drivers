...
```{r violin5,fig.cap='Model results for the 100-day SARS-X vaccine with the BPSV.',echo=F,warning=F,message=F,fig.height=5,fig.width=6}
p[[5]]
```
...
set100 <- subset(allallresults,igroup=='UMIC'&Policy=='School Closures'&scenario=='BAU')
set365 <- subset(allallresults,igroup=='UMIC'&Policy=='School Closures'&scenario=='Scenario 5')
