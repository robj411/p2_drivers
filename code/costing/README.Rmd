...
as the maximum demand for income group $i$, representing two doses each for $\lambda = `r rawpar$vaccine_coverage*100`$% of the population assuming vaccine wastage of $\delta = `r rawpar$vaccine_wastage`$.
...
- $A_3=0.5$ billion doses per year from reserved capacity go exclusively to HIC
