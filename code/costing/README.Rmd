...
ssv_capres$category = 'Reservation and procurement'
...
ggsave(rdplot, filename='../../results/rdplot.png')
...
capresplot = ggplot(df)  +
  ...
  theme(legend.position = 'top')
ggsave(capresplot, filename='../../results/capresplot.png')
...
bpplot = ggplot(df)  +
  ...
  theme(legend.position = 'top')
ggsave(bpplot, filename='../../results/bpplot.png')
...
ssv_res_df$category = 'Reservation and procurement'
...
bpsv_proc_res$category = 'Reservation and procurement'
...
unitplot$category = factor(unitplot$category,levels=c('R&D','Reservation and procurement','Delivery'),labels=c('R&D','Reservation\nand procurement','Delivery'))
...
# unitcosts =
  ...
  theme(legend.text = element_text(lineheight = .8), legend.key.height = unit(.8, "cm"), legend.key.width = unit(.8, "cm"))
```
...
ggsave(unitcosts + labs(title=''), filename='../../results/unit.png',height=5,width=10)
...
ggsave(fifcosts + labs(title=''), filename='../../results/fifteen.png',height=6,width=10)
