...
- $D_{BPSV, prepRD}$ is the R\&D cost of BPSV prior to an outbreak; see Equation \@ref(eq:)
- $D_{BPSV, inv}$ is the cost of maintaining an investigational reserve of 100,000 BPSV doses; see Equation \@ref(eq:)
- $D_{SSV, cap}$ is the cost of reserved capacity for SSV; see Equation \@ref(eq:)
...
- $D_{BPSV, resRD}$ is the R\&D cost of BPSV after an outbreak; see Equation \@ref(eq:)
- $D_{SSV, RD, s}$ is the R\&D cost for SSV; see Equation \@ref(eq:ssvrd)
- $D_{BPSV, proc}$ is the cost of procuring BPSV; see Equation \@ref(eq:)
- $D_{SSV, proc}$ is the cost of procuring SSV; see Equation \@ref(eq:)
- $D_{BPSV, del}$ is the cost of delivering BPSV; see Equation \@ref(eq:)
- $D_{SSV, del}$ is the cost of delivering SSV; see Equation \@ref(eq:)
...
ggplot(ssv_rd_plot) + geom_histogram(aes(Cost/1e9*18)) +
  ...
  labs(x='Cost, billion USD',y='',title='Risk-adjusted R&D cost for 18 candidates')
...
and we assume that the eight candidates have the same probability of success at Phase 3 as the SSV: 

$$p \sim \text{Binom}(8, P_3).$$

```{r bpsvrd}
set.seed(0)
x = 8 * 18/phase_duration[1,4] * costs[,4] + rbinom(n = nsamples, prob = pos[,4], size=8)*(1+pall$inflation)*pall$cost_lic
