...
for a final vaccine coverage of $\lambda = `r rawpar$vaccine_coverage`$.
...
as the maximum demand for income group $i$, representing two doses each for $\lambda = `r rawpar$vaccine_coverage*100`$% of the population assuming vaccine wastage of $\delta = `r round(rawpar$vaccine_wastage,2)`$.
...
- Once HIC reach their total demand, doses from reserved capacity are split proportional to population between UMIC, LMIC and LIC
