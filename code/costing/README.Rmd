...
The cost of each phase is $T_i$, a weighted average of experienced and inexperienced manufacturers. Assuming that $N^{\text{(BPSV)}}=`r rawpar$n_bpsv`$ candidates start in the preclinical phase, and two so far has experience with licensure (Table \@ref(tab:inex)), we take $\omega = `r round(rawpar$inex_weight,2)`$;
