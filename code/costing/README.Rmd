...
The cost per dose reservation per year is `r pall$cost_capres` USD, denoted $A_2$. Reservation sizes, in billions, depend on scenarios, including the $A_3=0.5$ billion doses reserved for HIC, as follows:
