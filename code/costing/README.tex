...
0.04 0.10 0.13 0.14 0.17 0.40

\subsection{BPSV investigational reserve}\label{bpsv-investigational-reserve}

\textbf{These are slightly too high. Could be the cost per dose.}

The cost per dose per year is \(A_1 = 2\) USD. Then the cost to maintain the reserve of 100,000 doses is
...
2.73 2.89 3.06 3.08 3.26 3.47

0.7
Min. 1st Qu. Median Mean 3rd Qu. Max.
6.55 6.93 7.35 7.38 7.82 8.34

2
Min. 1st Qu. Median Mean 3rd Qu. Max.
13.64 14.44 15.32 15.38 16.30 17.37
...
\includegraphics{README_files/figure-latex/en-1.pdf} 100
Min. 1st Qu. Median Mean 3rd Qu. Max.
7.21 7.63 8.09 8.13 8.61 9.17
...
\textbf{These don't match the spreadsheet results}
...
Min. 1st Qu. Median Mean 3rd Qu. Max.
0.07 0.18 0.25 0.28 0.33 1.53

200 Days Mission
Min. 1st Qu. Median Mean 3rd Qu. Max.
0.02 0.07 0.10 0.13 0.16 1.23

100 Days Mission
Min. 1st Qu. Median Mean 3rd Qu. Max.
0.01 0.05 0.07 0.08 0.10 0.67

\subsubsection{BPSV}\label{bpsv}

\textbf{This is quite different from the spreadsheet results}
...
Here, \(S_R = 6.29\) is the cost per reserved dose and \(S_U = 18.94\) the cost per unreserved dose in USD. Reserved doses are marked up by \(M_p = 0.2\) and \(M_f = 0.14\).
...
For a world population aged 65 and over of 0.8 billion, an uptake of 80\%, and a cost per dose of \(S_R = 6.29\) USD (the same as for SSV via reserved capacity), the procurement cost for BPSV is 4.06 billion USD.

Min. 1st Qu. Median Mean 3rd Qu. Max.
1.69 1.95 2.25 2.29 2.61 3.01
...
\textbf{These values are not correct}
...
\includegraphics{README_files/figure-latex/deliverycost-1.pdf} Min. 1st Qu. Median Mean 3rd Qu. Max.
73.82 94.39 103.50 105.38 115.20 148.18

\subsubsection{BPSV}\label{bpsv-2}

\textbf{These values are too low}
...
3.88 5.95 6.92 7.07 8.05 12.26
