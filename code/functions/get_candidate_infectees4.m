...
function [CI, strata_weights, contacts46] = get_candidate_infectees4(nStrata, dis, S,Sv1,Sv2, p3, p4, N, contact_matrix)
    ...
    contacts46 = contact_matrix494(adinds,3);
    contact_matrix4 = zeros(nStrata4);
    strata_weights = N(adinds)/sum(N(adinds));
    for i=1:nStrata4
        contact_matrix494(adinds,i) = contact_matrix494(adinds,i).*strata_weights;
