...
columnnames = {'School_contacts','School_age','Working_age','Elders',...
    ...
    'Response_time','Social_distancing_max','Social_distancing_rate','Candidate_infectees',...
    'R0','beta','Min_IHR','Max_IHR','Mean_IHR',...
    'Max_HFR','Max_IFR','Mean_IFR','Probability_symptomatic','Latent_period',...
    ...
    for ms = 1:length(strategies)
        ...
        %             dis2
            ...
            inputs(i,:)  = [ldata.schoolA2 ldata.NNs(47)/popsize working_age/popsize ldata.NNs(49)/popsize...
                ...
                max(dis2.hfr) max(dis2.ifr) mean(dis2.ifr) dis2.ps dis2.Tlat ...
