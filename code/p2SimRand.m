...
columnnames = {'School_contacts','School_age','Working_age','Elders',...
    'Unemployment_rate','GDP','Labour_share','workp',...
    'Community_contacts','Hospital_capacity','Test_rate','Test_start',...
    'Response_time','Social_distancing_min','Social_distancing_rate','Candidate_infectees',...
    'R0','beta','Min_IHR','Max_IHR','Mean_IHR',...
    'Max_HFR','Max_IFR','Probability_symptomatic','Latent_period',...
...
for il = 1:n_income
    ...
    for ms = 1:length(strategies)
        ...
        %             dis2
            ...
            inputs(i,:)  = [ldata.schoolA2 ldata.NNs(47)/popsize working_age/popsize ldata.NNs(49)/popsize...
                unemployment_rate ldata.gdp ldata.labsh ldata.workp ...
                ldata.comm ldata.Hmax ldata.trate ldata.t_tit ...
                ldata.Tres ldata.sdl ldata.sdb dis2.CI ...
                dis2.R0 dis2.beta min(dis2.ihr) max(dis2.ihr) mean(dis2.ihr) ...
                max(dis2.hfr) max(dis2.ifr) dis2.ps dis2.Tlat ...
