...
inputcolumnnames = {'VLY','VSY',...
    ...
    'Time_to_death'};
outputcolumnnames = {'Cost','Deaths','School','GDP_loss'};
...
for il = 1:n_income
    ...
    for ms = 1:length(strategies)
            ...
            for bl = 1:length(bpsv_levels)
                ...
                parfor i = 1:nsamples
                    ...
                    try
                        ...
                        [~,exitwave] = min(abs(f(:,1)-iseq(end,1)));
        ...
        disp(printendsusct(:,printendsusct(5,:)+1e-2<printendsusct(3,:)|printendsusct(4,:)+1e-2<printendsusct(2,:)));
    end
end
