...
ggplot(subset(vioplot,virus=='Influenza 2009'),aes(fill=igroup, y=value, x=igroup)) + 
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'figures/Influenza2009.pdf',width=12,height=10)
```
...
ggplot(subset(vioplot,virus=='Influenza 1957'),aes(fill=igroup, y=value, x=igroup)) + 
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'figures/Influenza1957.pdf',width=12,height=10)
```
...
ggplot(subset(vioplot,virus=='Influenza 1918'),aes(fill=igroup, y=value, x=igroup)) + 
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'figures/Influenza1918.pdf',width=12,height=10)
```
...
ggplot(subset(vioplot,virus=='SARS-CoV-2 Omicron'),aes(fill=igroup, y=value, x=igroup)) + 
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'figures/omicron.pdf',width=12,height=10)
```
...
ggplot(subset(vioplot,virus=='SARS-CoV-2 Delta'),aes(fill=igroup, y=value, x=igroup)) + 
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'figures/delta.pdf',width=12,height=10)
```
...
ggplot(subset(vioplot,virus=='SARS-CoV-1'),aes(fill=igroup, y=value, x=igroup)) + 
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'figures/sars.pdf',width=12,height=10)
```
