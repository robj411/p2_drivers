...
allresults$virus[allresults$virus=="Covid Wildtype"] <- 'SARS-CoV-2 pre-Alpha'
allresults$virus[allresults$virus=="Covid Omicron"] <- 'SARS-CoV-2 Omicron'
allresults$virus[allresults$virus=="Covid Delta"] <- 'SARS-CoV-2 Delta'
allresults$virus[allresults$virus=="SARS"] <- 'SARS-CoV-1'
vioplot <- melt(allresults[,(nvar-3):ncol(allresults)],id.vars=c('virus','strategy','igroup'))
...
ggplot(subset(vioplot,virus=='SARS-CoV-2 pre-Alpha'),aes(fill=igroup, y=value, x=igroup)) + 
  ...
  ggsave(p,filename = 'prealpha.pdf',width=12,height=10)
...
```{r,echo=F,warning=F,message=F}
subs3 <- subset(allresults,igroup=='LLMIC'&strategy=='Elimination'&virus=='SARS-CoV-2 pre-Alpha'&Food_sector<0.035&Food_sector>0.025)
...
subs6 <- subset(allresults,igroup=='LLMIC'&strategy=='Elimination'&virus=='SARS-CoV-2 pre-Alpha'&Food_sector<0.065&Food_sector>0.055)
...
voiall <- readRDS('results/voi_Covid Wildtype.Rds')
...
```{r mi,fig.cap='Mutual information (MI) for pre-Alpha variants of SARS-CoV-2.',eval=F,echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/mi_Covid Wildtype.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
ggplot(subset(allresults,igroup=='MIC'&strategy=='School Closures'&virus=='SARS-CoV-2 Delta'),aes(x=qbeta(Internet,3.77,2.91)*100,y=School)) +
...
ggplot(subset(allresults,igroup=='MIC'&strategy=='No Closures'&virus=='SARS-CoV-2 pre-Alpha'),aes(y=GDP_loss,x=Food_sector*100)) +
  geom_point(colour='navyblue') +
  theme_bw(base_size=15) +
  theme_bw(base_size=15) + geom_smooth(formula=y~ns(x,df=3),method='glm',colour='hotpink',se = F,size=2) +
...
ggplot(subset(allresults,igroup=='MIC'&strategy=='No Closures'&virus=='SARS-CoV-2 pre-Alpha')) +
...
hmaxi <- setDT(read.csv('VOI/country_data.csv'))
...
meantab <- setDT(allresults)[,.(deaths=mean(Deaths),
                        ...
                        gdp=mean(GDP_loss)),by=.(virus,strategy,igroup)]
reshape2::melt(meantab)

ggplot(reshape2::melt(meantab)) + geom_bar(aes(x=factor(strategy,levels=c('No Closures','School Closures','Economic Closures','Elimination')),y=value,fill=factor(variable,levels=c('education','deaths','gdp'),labels=c('Education','YLLs','GDP'))),stat='identity') + facet_grid(virus~factor(igroup,levels=c('LLMIC','MIC','HIC')),scales='free') + 
...
ggsave(p,filename='expectedcosts.pdf',height=10)
...
tabres <- setDT(allresults)[,list(costs=paste0(round(mean(Cost),1),' (',paste0(round(quantile(Cost,c(0.025,0.975)),1),collapse=', '),')'),
                        ...
                        ),by=.(virus,strategy,igroup)]
colnames(tabres) <- c('Virus','Strategy','Income group','Total costs','YLLs','Education','GDP')
...
```{r Influenza2009,fig.cap='Model results for Influenza 2009.',echo=F,warning=F,message=F,fig.width=6}
ggplot(subset(vioplot,virus=='Influenza 2009'),aes(fill=igroup, y=value, x=igroup)) + 
    geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent") +
  facet_grid(variable~strategy, scales="free") + 
    scale_fill_viridis(discrete=T, name="") +
    theme_bw(base_size = 18)  +
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'Influenza2009.pdf',width=12,height=10)
```

```{r Influenza1957,fig.cap='Model results for Influenza 1957.',echo=F,warning=F,message=F,fig.width=6}
ggplot(subset(vioplot,virus=='Influenza 1957'),aes(fill=igroup, y=value, x=igroup)) + 
    geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent") +
  facet_grid(variable~strategy, scales="free") + 
    scale_fill_viridis(discrete=T, name="") +
    theme_bw(base_size = 18)  +
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'Influenza1957.pdf',width=12,height=10)
```

```{r Influenza1918,fig.cap='Model results for Influenza 1918.',echo=F,warning=F,message=F,fig.width=6}
ggplot(subset(vioplot,virus=='Influenza 1918'),aes(fill=igroup, y=value, x=igroup)) + 
    geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent") +
  facet_grid(variable~strategy, scales="free") + 
    scale_fill_viridis(discrete=T, name="") +
    theme_bw(base_size = 18)  +
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'Influenza1918.pdf',width=12,height=10)
```

```{r Omicron,fig.cap='Model results for SARS-CoV-2 Omicron.',echo=F,warning=F,message=F,fig.width=6}
ggplot(subset(vioplot,virus=='SARS-CoV-2 Omicron'),aes(fill=igroup, y=value, x=igroup)) + 
    geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent") +
  facet_grid(variable~strategy, scales="free") + 
    scale_fill_viridis(discrete=T, name="") +
    theme_bw(base_size = 18)  +
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'omicron.pdf',width=12,height=10)
```

```{r Delta,fig.cap='Model results for SARS-CoV-2 Delta.',echo=F,warning=F,message=F,fig.width=6}
ggplot(subset(vioplot,virus=='SARS-CoV-2 Delta'),aes(fill=igroup, y=value, x=igroup)) + 
    geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent") +
  facet_grid(variable~strategy, scales="free") + 
    scale_fill_viridis(discrete=T, name="") +
    theme_bw(base_size = 18)  +
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'delta.pdf',width=12,height=10)
```

```{r sars,fig.cap='Model results for SARS-CoV-1.',echo=F,warning=F,message=F,fig.width=6}
ggplot(subset(vioplot,virus=='SARS-CoV-1'),aes(fill=igroup, y=value, x=igroup)) + 
    geom_violin(position="dodge", alpha=0.5, outlier.colour="transparent") +
  facet_grid(variable~strategy, scales="free") + 
    scale_fill_viridis(discrete=T, name="") +
    theme_bw(base_size = 18)  +
  ...
  scale_x_discrete(labels=c('','',''))+ 
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom')-> p
  ggsave(p,filename = 'sars.pdf',width=12,height=10)
```
...
```{r voiInfluenza2009,fig.cap='Value of information for Influenza 2009.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/voi_Influenza 2009.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
```{r miInfluenza2009,eval=F,fig.cap='Mutual information (MI) for Influenza 2009.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/mi_Influenza 2009.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
```{r voiInfluenza1957,fig.cap='Value of information for Influenza 1957.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/voi_Influenza 1957.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
```{r miInfluenza1957,eval=F,fig.cap='Mutual information (MI) for Influenza 1957.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/mi_Influenza 1957.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
```{r voiInfluenza1918,fig.cap='Value of information for Influenza 1918.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/voi_Influenza 1918.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
```{r miInfluenza1918,eval=F,fig.cap='Mutual information (MI) for Influenza 1918.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/mi_Influenza 1918.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
```{r voiomicron,fig.cap='Value of information for Omicron SARS-CoV-2.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/voi_Covid Omicron.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
```{r miomicron,eval=F,fig.cap='Mutual information (MI) for Omicron SARS-CoV-2.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/mi_Covid Omicron.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
```{r voidelta,fig.cap='Value of information for Delta SARS-CoV-2.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/voi_Covid Delta.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
```{r midelta,eval=F,fig.cap='Mutual information (MI) for Delta SARS-CoV-2.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/mi_Covid Delta.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
```{r voisars,fig.cap='Value of information for SARS-CoV-1.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/voi_SARS.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
```{r misars,eval=F,fig.cap='Mutual information (MI) for SARS-CoV-1.',echo=F,warning=F,message=F,fig.height=10}

voiall <- readRDS('results/mi_SARS.Rds')
rownames(voiall) <- gsub('Deaths:','YLLs:',rownames(voiall))
rownames(voiall) <- gsub('School:','Education:',rownames(voiall))
...
ggplot() +
  ...
  geom_density(data=subset(vioplot,virus=='SARS-CoV-2 pre-Alpha'&igroup=='LLMIC'&variable=='GDP'),aes(x=value, colour=strategy),size=2) + 
...
ggplot() +
  ...
  geom_density(data=subset(vioplot,virus=='SARS-CoV-2 pre-Alpha'&igroup=='MIC'&variable=='GDP'),aes(x=value, colour=strategy),size=2) + 
...
ggplot() +
  ...
  geom_density(data=subset(vioplot,virus=='SARS-CoV-2 pre-Alpha'&igroup=='HIC'&variable=='GDP'),aes(x=value, colour=strategy),size=2) + 
...
![Profiles from the game Pandemic Potential](pandemicprofiles.png)

![Profiles made using distribution from game](pathogenprofilessynth.png)


![Intensity and frequency of extreme novel epidemics, Marani et al., PNAS, 2021](marani2021.png)

\newpage

## Infection-hospitalisation rate (IHR)

![IHR by age for seven P2 pathogen profiles](trainingihr.png)

![Posterior samples for seven P2 pathogen IHR profiles](pathogenplot.png)

![Posterior distributions for IHR smooths](pairsplot.png)

![New IHR samples for synthetic pathogens](samplelogplot.png)
...
![HFR by age for seven P2 pathogen profiles](traininghfr.png)

![Posterior samples for seven P2 pathogen HFR profiles](pathogenplothfr.png)

![Posterior distributions for HFR smooths](pairsplothfr.png)

![New HFR samples for synthetic pathogens](samplelogplothfr.png)
