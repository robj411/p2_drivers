...
```{r mi,fig.cap='Mutual information (MI) for pre-Alpha variants of SARS-CoV-2.',echo=F,warning=F,message=F,fig.height=10}
...
```{r miInfluenza2009,fig.cap='Mutual information (MI) for Influenza 2009.',echo=F,warning=F,message=F,fig.height=10}
...
```{r miInfluenza1957,fig.cap='Mutual information (MI) for Influenza 1957.',echo=F,warning=F,message=F,fig.height=10}
...
```{r miInfluenza1918,fig.cap='Mutual information (MI) for Influenza 1918.',echo=F,warning=F,message=F,fig.height=10}
...
```{r miomicron,fig.cap='Mutual information (MI) for Omicron SARS-CoV-2.',echo=F,warning=F,message=F,fig.height=10}
...
```{r midelta,fig.cap='Mutual information (MI) for Delta SARS-CoV-2.',echo=F,warning=F,message=F,fig.height=10}
...
```{r misars,fig.cap='Mutual information (MI) for SARS-CoV-1.',echo=F,warning=F,message=F,fig.height=10}
