...
```{r prealpha,fig.cap='Model results for pre-alpha variants of SARS-CoV-2.',echo=F,warning=F,message=F,fig.width=8}
ggplot(subset(vioplot,virus=='SARS-CoV-2 pre-alpha'),aes(fill=igroup, y=value, x=igroup)) + 
  ...
  theme(axis.ticks.x=element_blank(),panel.spacing = unit(0.5, "lines"),legend.position = 'bottom',legend.box.spacing=unit(-1,'cm'))
...
- Contact matrices: [@Prem2021], [@Beraud2015]
- Work from home: [@Gottlieb2021]
...
- Population: 
- Tourism data: https://www.unwto.org/tourism-data/international-tourism-and-covid-19
- International tourism: https://www.unwto.org/tourism-statistics/key-tourism-statistics
...
```{r Influenza2009,fig.cap='Model results for Influenza 2009.',echo=F,warning=F,message=F,fig.width=8}
...
```{r Influenza1957,fig.cap='Model results for Influenza 1957.',echo=F,warning=F,message=F,fig.width=8}
...
```{r Influenza1918,fig.cap='Model results for Influenza 1918.',echo=F,warning=F,message=F,fig.width=8}
...
```{r omicron,fig.cap='Model results for SARS-CoV-2 omicron.',echo=F,warning=F,message=F,fig.width=8}
...
```{r delta,fig.cap='Model results for SARS-CoV-2 delta.',echo=F,warning=F,message=F,fig.width=8}
...
```{r sars,fig.cap='Model results for SARS-CoV-1.',echo=F,warning=F,message=F,fig.width=8}
