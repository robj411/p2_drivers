...
- <a href="#methods" id="toc-methods">2 Methods</a>
  - <a href="#scenarios" id="toc-scenarios">2.1 Scenarios</a>
  - <a href="#outcomes" id="toc-outcomes">2.2 Outcomes</a>
  - <a href="#modelling" id="toc-modelling">2.3 Modelling</a>
  - <a href="#value-of-information" id="toc-value-of-information">2.4 Value
    of information</a>
- <a href="#results" id="toc-results">3 Results</a>
  - <a href="#distributions-over-outcomes"
    id="toc-distributions-over-outcomes">3.1 Distributions over outcomes</a>
  - <a href="#value-of-information-1" id="toc-value-of-information-1">3.2
    Value of information</a>
- <a href="#conclusions" id="toc-conclusions">4 Conclusions</a>
  - <a href="#the-modelling-framework" id="toc-the-modelling-framework">4.1
    The modelling framework</a>
  - <a href="#the-economic-model" id="toc-the-economic-model">4.2 The
    economic model</a>
- <a href="#references" id="toc-references">5 References</a>
- <a href="#methodological-developments-specific-to-this-application"
  id="toc-methodological-developments-specific-to-this-application">6
  Methodological developments specific to this application</a>
  - <a href="#impact-of-tourism" id="toc-impact-of-tourism">6.1 Impact of
    tourism</a>
    - <a href="#food-and-accommodation-services-sector"
      id="toc-food-and-accommodation-services-sector">6.1.1 Food and
      accommodation services sector</a>
    - <a href="#sector-shrinkage-as-a-result-of-the-pandemic"
      id="toc-sector-shrinkage-as-a-result-of-the-pandemic">6.1.2 Sector
      shrinkage as a result of the pandemic</a>
    - <a href="#loss-of-international-tourists"
      id="toc-loss-of-international-tourists">6.1.3 Loss of international
      tourists</a>
    - <a href="#dependence-on-international-tourism"
      id="toc-dependence-on-international-tourism">6.1.4 Dependence on
      international tourism</a>
  - <a href="#sampling-sector-sizes" id="toc-sampling-sector-sizes">6.2
    Sampling sector sizes</a>
  - <a href="#impact-of-sector-sizes" id="toc-impact-of-sector-sizes">6.3
    Impact of sector sizes</a>
  - <a href="#internet-infrastructure" id="toc-internet-infrastructure">6.4
    Internet infrastructure</a>
    - <a href="#remote-teaching" id="toc-remote-teaching">6.4.1 Remote
      teaching</a>
  - <a href="#hospital-capacity" id="toc-hospital-capacity">6.5 Hospital
    capacity</a>
- <a
  href="#comparison-of-model-results-for-sars-cov-2-pre-alpha-to-2020-data"
  id="toc-comparison-of-model-results-for-sars-cov-2-pre-alpha-to-2020-data">7
  Comparison of model results for SARS-CoV-2 (pre-alpha) to 2020 data</a>
  - <a href="#gdp-loss" id="toc-gdp-loss">7.1 GDP loss</a>
  - <a href="#school-closure" id="toc-school-closure">7.2 School closure</a>
  - <a href="#value-of-lives-lost" id="toc-value-of-lives-lost">7.3 Value of
    lives lost</a>
...
observed in 2020, where the monthly GVA of a sector relative to its
...
each sector is open in each month. A sector is open to a maximum amount
of 100%, when its full monthly GVA value is realised. If a sector is
open to 50%, it contributes 50% of its maximum GVA that month. In the
epidemic model, contacts associated with that sector – between workers,
from workers to consumers, and between consumers – are likewise scaled
down.
...
parameters. While EVPPI allows us to identify important relationships in
this way, it also means that we cannot make statements such as “a 3%
increase in this input leads to a 1% increase in this outcome.”
...
At 3%, life-year loss is expected to be 7.94% of GDP (95%PI 0, 71.98).
Education loss is expected to be 29.91% of GDP (95%PI 1.24, 68.14). GDP
loss is expected to be 15.87% of GDP (95%PI 2.48, 24.87).

At 6%, life-year loss is expected to be 6.04% of GDP (95%PI 0, 39.78).
Education loss is expected to be 31.01% of GDP (95%PI 2.45, 72.47). GDP
loss is expected to be 18.16% of GDP (95%PI 5.2, 27.19).
...
R![\_0](https://latex.codecogs.com/png.latex?_0 "_0") and hospital
capacity combined, and
R![\_0](https://latex.codecogs.com/png.latex?_0 "_0") and testing rate
combined. These variables together explain much of the variance in GDP
loss for the Economic Closures and Elimination strategies, respectively.

![Figure 3.2: Value of information for pre-alpha variants of
SARS-CoV-2.](p2_files/figure-gfm/voi-1.png)

![Figure 3.3: Because of the very heavily skewed distribution of the
food and accommodation services sector as a share of GDP, mutual
information (MI) might be better.](p2_files/figure-gfm/mi-1.png)
...
<a href="#fig:tourismgdp">3.4</a>: for middle-income countries in a
...
![Figure 3.4: Relationship between tourism parameters and GDP loss for
...
![Figure 3.5: Model results for Influenza
2009.](p2_files/figure-gfm/Influenza2009-1.png)

![Figure 3.6: Model results for Influenza
1957.](p2_files/figure-gfm/Influenza1957-1.png)

![Figure 3.7: Model results for Influenza
1918.](p2_files/figure-gfm/Influenza1918-1.png)

![Figure 3.8: Model results for SARS-CoV-2
omicron.](p2_files/figure-gfm/omicron-1.png)

![Figure 3.9: Model results for SARS-CoV-2
delta.](p2_files/figure-gfm/delta-1.png)

![Figure 3.10: Model results for
SARS-CoV-1.](p2_files/figure-gfm/sars-1.png)
...
model mimics reality, or at least captures the most salient aspects of
it.
...
# 6 Methodological developments specific to this application
...
## 6.1 Impact of tourism

### 6.1.1 Food and accommodation services sector
...
### 6.1.2 Sector shrinkage as a result of the pandemic
...
We model mitigation via business closures, which are mandated per month
and by sector. We represent openness with values
...
is the openness of the sector in month
...
### 6.1.3 Loss of international tourists
...
### 6.1.4 Dependence on international tourism
...
Results are shown in Figure <a href="#fig:sectortourism">5.1</a>. We use
these values as inputs for all country models.

<figure>
<img src="sectortourism.png" style="width:60.0%"
alt="Figure 5.1: Predicting the percentage of tourism that comes from abroad as a function of the size of the sector. Each row represents a beta distribution whose mean is determined by the size of the sector (u). Blue points show the data we have available (grey bars in Figure ??)." />
<figcaption aria-hidden="true">Figure 5.1: Predicting the percentage of
...
<a href="#fig:candidateinfectees">5.2</a>.

<figure>
<img src="candidateinfectees.png" style="width:80.0%"
alt="Figure 5.2: The number of candidate infectees is mapped to the basic reproduction number R_0 via matching quantiles from the simulated null distribution (left) to the parametric distribution (right). 10, 50 and 90% quantiles shown." />
<figcaption aria-hidden="true">Figure 5.2: The number of candidate
...
<a href="#fig:internet">5.3</a>) multiplied by 0.86, to match values for
...
![Figure 5.3: Internet access by income level. World Bank data for
2019.](p2_files/figure-gfm/internet-1.png)

We model the Figure <a href="#fig:internet">5.3</a> values with Beta
...
<a href="#fig:labsh">5.4</a>). (This correction might lead us to
...
![Figure 5.4: Fraction of GVA that goes to labour (PWT,
...
## 6.5 Hospital capacity

![Figure 5.5: Fraction of GVA that goes to labour (PWT,
...
# 7 Comparison of model results for SARS-CoV-2 (pre-alpha) to 2020 data
...
![Figure 5.6: GDP loss: loss in 2020 as a percentage of 2019 GDP (IMF).
...
![Figure 5.7: GDP loss: loss in 2020 as a percentage of 2019 GDP (IMF)
...
![Figure 5.8: GDP loss: loss in 2020 as a percentage of 2019 GDP (IMF)
...
![Figure 5.9: GDP loss: loss in 2020 as a percentage of 2019 GDP (IMF)
...
![Figure 5.10: Extent of school closure. Horizontal lines (one per
...
## 7.3 Value of lives lost

![Figure 5.11: Valued loss of life, using IHME estimates (“cumulative
